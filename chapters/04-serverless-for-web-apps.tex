...
At the first glance the web application client's architecture should not be significantly affected by the changes of the underlying server and storage architecture to use the serverless architecture.
