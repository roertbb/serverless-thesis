...
\begin{itemize}
    \item from the user experience perspective --- the bset performance --- delivering and displaying the initial batch as soon as possible, while processing the remaining part, delivering it and updating the client state once its completed
\end{itemize}
